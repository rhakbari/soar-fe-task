    ...
    <div className="font-['Montserrat',sans-serif] text-sm leading-snug">
      <div className="flex-wrap m-2">
        <div className="w-[335px] h-[215px] relative">
          {/* Card Container */}
          <div className="w-full h-full rounded-2xl text-white shadow-lg bg-gradient-to-r from-gray-600 to-gray-900 overflow-hidden">
            {/* Top Section */}
            ...
            <div className="absolute top-1/2 -translate-y-1/2 w-full px-6">
              <div className="flex justify-between items-start font-mono">
                <div>
                  <div className="text-xs text-white/80 mb-1">CARD HOLDER</div>
                  <div>{cardHolder}</div>
                </div>
                <div>
